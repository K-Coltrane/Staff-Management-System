...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Conferences</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Conferences</h4>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0">All Conferences</h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addConferenceModal">
                        <i class="icon-base bx bx-plus me-2"></i>Add Conference
                      </button>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            $conferencesQuery = "SELECT * FROM conferences ORDER BY start_date DESC";
                            $conferencesResult = mysqli_query($conn, $conferencesQuery);
                            
                            if ($conferencesResult && mysqli_num_rows($conferencesResult) > 0):
                                while ($conference = mysqli_fetch_assoc($conferencesResult)):
                            ?>
                            <tr>
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div>
                                    <h6 class="mb-0"><?php echo $conference['name']; ?></h6>
                                    <small class="text-muted"><?php echo $conference['conference_id']; ?></small>
                                  </div>
                                </div>
                              </td>
                              <td><?php echo $conference['location']; ?></td>
                              <td><?php echo date('M d, Y', strtotime($conference['start_date'])); ?></td>
                              <td><?php echo date('M d, Y', strtotime($conference['end_date'])); ?></td>
                              <td>
                                <span class="badge bg-<?php echo $conference['type'] == 'international' ? 'primary' : 'secondary'; ?>">
                                  <?php echo ucfirst($conference['type']); ?>
                                </span>
                              </td>
                              <td>
                                <span class="badge bg-<?php echo $conference['status'] == 'active' ? 'success' : 'warning'; ?>">
