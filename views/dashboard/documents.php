        ...
        <div class="layout-page">
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <div class="card-body">
                  <a href="contracts.php" class="btn btn-primary me-2">Contracts</a>
                  <a href="certifications.php" class="btn btn-outline-primary me-2">Certifications</a>
                  <a href="licenses.php" class="btn btn-outline-primary me-2">Licenses</a>
                  <a href="performance_reviews.php" class="btn btn-outline-primary">Performance Reviews</a>
                </div>
              </div>
            </div>
...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Documents</title>
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <!-- Content -->
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Document Management</h4>
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <div class="d-flex gap-2">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#uploadDocumentModal">
                          <i class="icon-base bx bx-upload me-2"></i>Upload Document
                        </button>
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="avatar avatar-sm me-3">
                                    <span class="avatar-initial rounded-circle bg-<?php echo $document['document_type'] == 'contract' ? 'primary' : ($document['document_type'] == 'certification' ? 'success' : ($document['document_type'] == 'license' ? 'info' : 'warning')); ?>">
                                      <i class="icon-base bx bx-file"></i>
                                    </span>
                                  </div>
                                  <div>
                                    <h6 class="mb-0"><?php echo $document['document_name']; ?></h6>
                                    <small class="text-muted"><?php echo $document['file_size']; ?> KB</small>
                                  </div>
                                </div>
                              </td>
                              <td>
                                <span class="badge bg-<?php echo $document['document_type'] == 'contract' ? 'primary' : ($document['document_type'] == 'certification' ? 'success' : ($document['document_type'] == 'license' ? 'info' : 'warning')); ?>">
                              ...
                              <td><?php echo $document['expiry_date'] ? date('M d, Y', strtotime($document['expiry_date'])) : 'N/A'; ?></td>
                              <td>
                                <span class="badge bg-<?php echo $document['status'] == 'active' ? 'success' : ($document['status'] == 'expired' ? 'danger' : 'warning'); ?>">
    ...
    <script src="assets/vendor/libs/menu.js"></script>
