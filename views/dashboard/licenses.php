...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Licenses</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Licenses</h4>
                  ...
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addLicenseModal">
                        <i class="icon-base bx bx-plus me-2"></i>Add License
                      </button>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            $licensesQuery = "SELECT l.*, ep.first_name, ep.last_name 
                                            FROM licenses l 
                                            LEFT JOIN employee_profiles ep ON l.employee_id = ep.employee_id 
                                            ORDER BY l.issue_date DESC";
                            $licensesResult = mysqli_query($conn, $licensesQuery);
                            
                            if ($licensesResult && mysqli_num_rows($licensesResult) > 0):
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div>
                                    <h6 class="mb-0"><?php echo $license['license_name']; ?></h6>
                                    <small class="text-muted"><?php echo $license['license_id']; ?></small>
                                  </div>
                                </div>
                              </td>
                              ...
                              <td>
                                <span class="badge bg-<?php echo $license['status'] == 'active' ? 'success' : ($license['status'] == 'expired' ? 'danger' : 'warning'); ?>">
