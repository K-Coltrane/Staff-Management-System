...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Employment History</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Employment History</h4>
                  ...
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addEmploymentModal">
                        <i class="icon-base bx bx-plus me-2"></i>Add Employment Record
                      </button>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            $employmentQuery = "SELECT * FROM employment_history ORDER BY start_date DESC";
                            $employmentResult = mysqli_query($conn, $employmentQuery);
                            
                            if ($employmentResult && mysqli_num_rows($employmentResult) > 0):
                                while ($employment = mysqli_fetch_assoc($employmentResult)):
                            ?>
                            <tr>
                              <td><?php echo $employment['company_name']; ?></td>
                              <td><?php echo $employment['position']; ?></td>
                              <td><?php echo date('M d, Y', strtotime($employment['start_date'])); ?></td>
                              <td><?php echo $employment['end_date'] ? date('M d, Y', strtotime($employment['end_date'])) : 'Present'; ?></td>
                              <td>
                                <?php
                                $start = new DateTime($employment['start_date']);
                                $end = $employment['end_date'] ? new DateTime($employment['end_date']) : new DateTime();
                                $interval = $start->diff($end);
                                echo $interval->y . ' years ' . $interval->m . ' months';
                                ?>
                              </td>
                              <td>
                                <span class="badge bg-<?php echo $employment['end_date'] ? 'secondary' : 'success'; ?>">
                                  <?php echo $employment['end_date'] ? 'Past' : 'Current'; ?>
                                </span>
                              </td>
                              <td>
                                <div class="dropdown">
                            ...
                            ?>
                            <tr>
                              <td colspan="7" class="text-center">No employment history found</td>
                            </tr>
                            <?php endif; ?>
                          </tbody>
                        </table>
