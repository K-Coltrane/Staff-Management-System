...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Employee Profiles</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Employee Profiles</h4>

              <!-- Employee Profiles Content -->
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0">All Employee Profiles</h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addEmployeeModal">
                        <i class="icon-base bx bx-plus me-2"></i>Add Employee
                      </button>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            $employeesQuery = "SELECT ep.*, d.name AS department_name 
                            ...
                            <tr>
                              ...
                              <td>
                                <span class="badge bg-<?php echo $employee['employment_status'] == 'Active' ? 'success' : ($employee['employment_status'] == 'Inactive' ? 'secondary' : 'warning'); ?>">
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="personal_info.php?id=<?php echo $employee['employee_id']; ?>">Personal Info</a></li>
                                    <li><a class="dropdown-item" href="employment_history.php?id=<?php echo $employee['employee_id']; ?>">Employment History</a></li>
