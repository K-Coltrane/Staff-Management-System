...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Family Information</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Family Information</h4>
                  ...
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addFamilyMemberModal">
                        <i class="icon-base bx bx-plus me-2"></i>Add Family Member
                      </button>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            $familyQuery = "SELECT * FROM family_members ORDER BY relationship";
                            $familyResult = mysqli_query($conn, $familyQuery);
                            
                            if ($familyResult && mysqli_num_rows($familyResult) > 0):
                                while ($member = mysqli_fetch_assoc($familyResult)):
                            ?>
                            <tr>
                              <td><?php echo $member['first_name'] . ' ' . $member['last_name']; ?></td>
                              <td>
                                <span class="badge bg-<?php echo $member['relationship'] == 'Spouse' ? 'primary' : ($member['relationship'] == 'Child' ? 'success' : 'info'); ?>">
                              ...
                              <td>
                                <span class="badge bg-<?php echo $member['is_emergency_contact'] ? 'success' : 'secondary'; ?>">
                                  <?php echo $member['is_emergency_contact'] ? 'Yes' : 'No'; ?>
                                </span>
                              </td>
                              <td>
                                <div class="dropdown">
