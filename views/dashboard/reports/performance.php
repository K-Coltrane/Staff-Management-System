                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Performance Reports</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="text-center py-5">
                                            <i class="bx bx-line-chart display-1 text-primary"></i>
                                            <h4 class="mt-3">Performance Reports</h4>
                                            <p class="text-muted">Generate comprehensive performance reports and analytics.</p>
                                            <div class="mt-4">
