...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Apply Leave</title>
                      ...
                      <form>
                        ...
                        <div class="row">
                          <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" rows="4" placeholder="Please provide a detailed reason for your leave request" required></textarea>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6 mb-3">
