...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Staff Promotion</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Staff Promotion</h4>

              <!-- Staff Promotion Content -->
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0">Promote Staff</h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#promoteStaffModal">
                        <i class="icon-base bx bx-plus me-2"></i>Promote Staff
                      </button>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            $promotionsQuery = "SELECT sp.*, ep.first_name, ep.last_name, ep.position_id 
                            ...
                            if ($promotionsResult && mysqli_num_rows($promotionsResult) > 0):
                                while ($promotion = mysqli_fetch_assoc($promotionsResult)):
                            ?>
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="avatar avatar-sm me-3">
                                    <span class="avatar-initial rounded-circle bg-success">
                                      <?php echo strtoupper(substr($promotion['first_name'], 0, 1) . substr($promotion['last_name'], 0, 1)); ?>
                                    </span>
                                  </div>
                                  <div>
                                    <h6 class="mb-0"><?php echo $promotion['first_name'] . ' ' . $promotion['last_name']; ?></h6>
                                    <small class="text-muted"><?php echo $promotion['employee_id']; ?></small>
                                  </div>
                                </div>
                              </td>
                              <td><?php echo isset($promotion['old_position_id']) ? $promotion['old_position_id'] : 'N/A'; ?></td>
                              <td>
                                <span class="badge bg-primary"><?php echo isset($promotion['new_position_id']) ? $promotion['new_position_id'] : 'N/A'; ?></span>
                              </td>
                              <td><?php echo date('M d, Y', strtotime($promotion['promotion_date'])); ?></td>
                              <td>
                                <span class="text-success fw-semibold">
                                  +$<?php echo number_format($promotion['salary_increase']); ?>
                                </span>
                              </td>
                              <td>
                                <span class="badge bg-<?php echo $promotion['status'] == 'approved' ? 'success' : ($promotion['status'] == 'pending' ? 'warning' : 'danger'); ?>">
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="javascript:void(0);">Approve</a></li>
                                    <li><a class="dropdown-item" href="javascript:void(0);">Reject</a></li>
