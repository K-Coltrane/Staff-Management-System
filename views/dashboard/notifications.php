...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Notifications</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Alerts & Notifications</h4>
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <div class="d-flex gap-2">
                        <button class="btn btn-outline-primary">
                          <i class="icon-base bx bx-check me-2"></i>Mark All Read
                        </button>
                        <button class="btn btn-outline-danger">
                          <i class="icon-base bx bx-trash me-2"></i>Clear All
                        </button>
                      </div>
                    </div>
                    <div class="card-body">
                      <div class="list-group">
                        ...
                        $notificationsQuery = "SELECT * FROM notifications ORDER BY created_at DESC LIMIT 20";
                          ...
                          <div class="d-flex w-100 justify-content-between">
                            <div class="d-flex">
                              <div class="avatar avatar-sm me-3">
                                <span class="avatar-initial rounded-circle bg-<?php echo $notification['type'] == 'success' ? 'success' : ($notification['type'] == 'warning' ? 'warning' : ($notification['type'] == 'error' ? 'danger' : 'info')); ?>">
                                  <i class="icon-base bx bx-<?php echo $notification['type'] == 'success' ? 'check' : ($notification['type'] == 'warning' ? 'exclamation' : ($notification['type'] == 'error' ? 'x' : 'info')); ?>"></i>
                                </span>
                              </div>
                              <div>
                            ...
                            <div class="d-flex align-items-center">
                              <span class="badge bg-<?php echo $notification['is_read'] ? 'secondary' : 'primary'; ?> me-2">
                        ...
                        <div class="text-center py-5">
                          <i class="icon-base bx bx-bell-off text-muted" style="font-size: 3rem;"></i>
