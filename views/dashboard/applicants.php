...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Applicants</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Applicants</h4>
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><?php echo $applicant['job_title'] ?? 'N/A'; ?></td>
                              <td>
                                <span class="badge bg-<?php echo $applicant['status'] == 'pending' ? 'warning' : ($applicant['status'] == 'accepted' ? 'success' : ($applicant['status'] == 'rejected' ? 'danger' : 'info')); ?>">
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="javascript:void(0);">View Resume</a></li>
                                    <li><a class="dropdown-item" href="javascript:void(0);">Schedule Interview</a></li>
                                    <li><a class="dropdown-item" href="javascript:void(0);">Accept</a></li>
