...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Contracts</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Contracts</h4>
                  ...
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addContractModal">
                        <i class="icon-base bx bx-plus me-2"></i>Add Contract
                      </button>
                    </div>
                    <div class="card-body">
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="javascript:void(0);">View Contract</a></li>
                                    ...
                                    <li><a class="dropdown-item text-danger" href="javascript:void(0);">Terminate</a></li>
                                  </ul>
                                </div>
                              </td>
                            </tr>
