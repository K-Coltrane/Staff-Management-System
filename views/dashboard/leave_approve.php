...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Approve Leave</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Approve Leave Requests</h4>

              <!-- Approve Leave Content -->
              <div class="row">
                <div class="col-12">
                  <div class="card">
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <button class="btn btn-sm btn-outline-info" data-bs-toggle="modal" data-bs-target="#reasonModal<?php echo $leave['leave_id']; ?>">
                                  View Reason
                                </button>
                              </td>
                              <td>
                                <div class="d-flex gap-1">
                                  <button class="btn btn-sm btn-success" onclick="approveLeave(<?php echo $leave['leave_id']; ?>)">
                                    <i class="icon-base bx bx-check"></i> Approve
                                  </button>
                                  <button class="btn btn-sm btn-danger" onclick="rejectLeave(<?php echo $leave['leave_id']; ?>)">
