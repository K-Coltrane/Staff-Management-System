                    ...
                    <table class="table table-hover">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-label-<?php echo $row['status'] === 'active' ? 'success' : 'danger'; ?>">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item status-change" href="javascript:void(0);" 
                                               ...
                                               data-status="<?php echo $row['status'] === 'active' ? 'inactive' : 'active'; ?>">
                                                <i class="bx bx-<?php echo $row['status'] === 'active' ? 'power-off' : 'check'; ?> me-1"></i> 
