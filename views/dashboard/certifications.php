...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Certifications</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Certifications</h4>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0">All Certifications</h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCertificationModal">
                        <i class="icon-base bx bx-plus me-2"></i>Add Certification
                      </button>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            $certificationsQuery = "SELECT c.*, ep.first_name, ep.last_name 
                                                  FROM certifications c 
                                                  LEFT JOIN employee_profiles ep ON c.employee_id = ep.employee_id 
                                                  ORDER BY c.issue_date DESC";
                            $certificationsResult = mysqli_query($conn, $certificationsQuery);
                            
                            if ($certificationsResult && mysqli_num_rows($certificationsResult) > 0):
                                while ($certification = mysqli_fetch_assoc($certificationsResult)):
                            ?>
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="avatar avatar-sm me-3">
                                    <span class="avatar-initial rounded-circle bg-success">
                                      <i class="icon-base bx bx-certification"></i>
                                    </span>
                                  </div>
                                  <div>
                                    <h6 class="mb-0"><?php echo $certification['certification_name']; ?></h6>
                                    <small class="text-muted"><?php echo $certification['certification_id']; ?></small>
                                  </div>
                                </div>
                              </td>
                              <td><?php echo $certification['first_name'] . ' ' . $certification['last_name']; ?></td>
                              <td><?php echo $certification['issuing_organization']; ?></td>
                              <td><?php echo date('M d, Y', strtotime($certification['issue_date'])); ?></td>
                              <td><?php echo date('M d, Y', strtotime($certification['expiry_date'])); ?></td>
                              <td>
                                <span class="badge bg-<?php echo $certification['status'] == 'active' ? 'success' : ($certification['status'] == 'expired' ? 'danger' : 'warning'); ?>">
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="javascript:void(0);">Renew</a></li>
