...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Performance Reviews</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Performance Reviews</h4>
                  ...
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addReviewModal">
                        <i class="icon-base bx bx-plus me-2"></i>Add Review
                      </button>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            $reviewsQuery = "SELECT pr.*, ep.first_name, ep.last_name, r.first_name as reviewer_first, r.last_name as reviewer_last 
                                           FROM performance_reviews pr 
                                           LEFT JOIN employee_profiles ep ON pr.employee_id = ep.employee_id 
                                           LEFT JOIN employee_profiles r ON pr.reviewer_id = r.employee_id 
                            ...
                            <tr>
                              ...
                              <td><?php echo $review['reviewer_first'] . ' ' . $review['reviewer_last']; ?></td>
                              <td><?php echo $review['review_period']; ?></td>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="progress me-2" style="width: 60px; height: 8px;">
                                    <div class="progress-bar bg-<?php echo $review['overall_rating'] >= 4 ? 'success' : ($review['overall_rating'] >= 3 ? 'warning' : 'danger'); ?>" 
                                         style="width: <?php echo ($review['overall_rating'] / 5) * 100; ?>%"></div>
                                  </div>
                                  <span class="fw-semibold"><?php echo $review['overall_rating']; ?>/5</span>
                                </div>
                              </td>
                              <td>
                                <span class="badge bg-<?php echo $review['status'] == 'completed' ? 'success' : ($review['status'] == 'in_progress' ? 'warning' : 'info'); ?>">
