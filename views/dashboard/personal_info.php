...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Personal Information</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Personal Information</h4>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0">Employee Personal Information</h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editPersonalInfoModal">
                        <i class="icon-base bx bx-edit me-2"></i>Edit Information
                      </button>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="mb-4">
                            ...
                            <p class="form-control-plaintext">January 15, 1990</p>
                          </div>
                          <div class="mb-4">
                          ...
                          <div class="mb-4">
                            ...
                            <p class="form-control-plaintext">Single</p>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="mb-4">
                            <label class="form-label fw-semibold">Email</label>
                            <p class="form-control-plaintext">john.doe@company.com</p>
                          </div>
                          <div class="mb-4">
                          ...
                          <div class="mb-4">
                            ...
                            <p class="form-control-plaintext">123 Main Street, City, State 12345</p>
                          </div>
                          <div class="mb-4">
                            <label class="form-label fw-semibold">Emergency Contact</label>
                            <p class="form-control-plaintext">Jane Doe - +1 (555) 987-6543</p>
                          </div>
                        </div>
                      </div>
                    </div>
