...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Publications</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Publications</h4>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0">All Publications</h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addPublicationModal">
                        <i class="icon-base bx bx-plus me-2"></i>Add Publication
                      </button>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            $publicationsQuery = "SELECT p.*, ep.first_name, ep.last_name 
                                                FROM publications p 
                                                LEFT JOIN employee_profiles ep ON p.author_id = ep.employee_id 
                                                ORDER BY p.publication_date DESC";
                            $publicationsResult = mysqli_query($conn, $publicationsQuery);
                            
                            if ($publicationsResult && mysqli_num_rows($publicationsResult) > 0):
                                while ($publication = mysqli_fetch_assoc($publicationsResult)):
                            ?>
                            <tr>
                                ...
                                <div class="d-flex align-items-center">
                                  <div class="avatar avatar-sm me-3">
                                    <span class="avatar-initial rounded-circle bg-primary">
                                      <i class="icon-base bx bx-file-text"></i>
                                    </span>
                                  </div>
                                  <div>
                                    <h6 class="mb-0"><?php echo $publication['title']; ?></h6>
                                    <small class="text-muted"><?php echo $publication['publication_id']; ?></small>
                                  </div>
                                </div>
                              </td>
                              <td><?php echo $publication['first_name'] . ' ' . $publication['last_name']; ?></td>
                              <td><?php echo $publication['journal_conference']; ?></td>
                              <td><?php echo date('M d, Y', strtotime($publication['publication_date'])); ?></td>
                              <td>
                                <span class="badge bg-<?php echo $publication['type'] == 'journal' ? 'primary' : 'info'; ?>">
                                  <?php echo ucfirst($publication['type']); ?>
                                </span>
                              </td>
                              <td><?php echo $publication['impact_factor'] ?? 'N/A'; ?></td>
                              <td>
                                <div class="dropdown">
