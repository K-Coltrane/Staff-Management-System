...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Promotion History</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Promotion History</h4>

              <!-- Promotion History Content -->
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-outline-primary">
                          <i class="icon-base bx bx-filter me-2"></i>Filter
                        </button>
                      </div>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            <?php
                            // Get promotion history from database
                            $promotionsQuery = "SELECT p.*, ep.first_name, ep.last_name 
                                             FROM promotions p 
                            ...
                            if ($promotionsResult && mysqli_num_rows($promotionsResult) > 0):
                                while ($promotion = mysqli_fetch_assoc($promotionsResult)):
                                    $increasePercent = (($promotion['new_salary'] - $promotion['old_salary']) / $promotion['old_salary']) * 100;
                            ?>
                            <tr>
                              <td><?php echo $promotion['promotion_id']; ?></td>
                              <td><?php echo $promotion['first_name'] . ' ' . $promotion['last_name']; ?></td>
                              <td><?php echo $promotion['old_position']; ?></td>
                              <td>
                                <span class="badge bg-primary"><?php echo $promotion['new_position']; ?></span>
                              </td>
                              <td><?php echo date('M d, Y', strtotime($promotion['promotion_date'])); ?></td>
                              <td>$<?php echo number_format($promotion['old_salary']); ?></td>
                              <td>$<?php echo number_format($promotion['new_salary']); ?></td>
                              <td>
                                <span class="text-success fw-semibold">
                                  +<?php echo number_format($increasePercent, 1); ?>%
                                </span>
                              </td>
                              <td>
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="javascript:void(0);">Download PDF</a></li>
                            ...
                            ?>
                            <tr>
                              <td colspan="10" class="text-center">No promotion history found</td>
                            </tr>
                            <?php endif; ?>
                          </tbody>
                        </table>
