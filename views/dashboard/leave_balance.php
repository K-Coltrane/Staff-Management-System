...
<html
  ...
  <head>
    ...
    <title>Staff Management System - Leave Balance</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Leave Balance</h4>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h5 class="card-title mb-0">Your Leave Balance</h5>
                    </div>
                    <div class="card-body">
                      <div class="row">
                            ...
                            <div class="card-body text-center">
                              <div class="avatar avatar-lg mx-auto mb-3">
                                <span class="avatar-initial rounded-circle bg-danger">
                                  <i class="icon-base bx bx-heart"></i>
                                </span>
                              </div>
                            ...
                            <div class="card-body text-center">
                              <div class="avatar avatar-lg mx-auto mb-3">
                                <span class="avatar-initial rounded-circle bg-success">
                                  <i class="icon-base bx bx-baby"></i>
                                </span>
                              </div>
                      ...
                      <div class="row mt-4">
                        <div class="col-12">
                          <div class="card">
                            <div class="card-header">
                              <h5 class="card-title mb-0">Leave Usage Summary</h5>
                            </div>
                            <div class="card-body">
